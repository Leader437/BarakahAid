...
/**
 * Admin Sidebar with navigation links and icons
...
const AdminSidebar = ({ isOpen, onClose }) => {
    ...
    return (
        <>
            ...
            {/* Sidebar */}
            <aside
                className={`fixed top-16 left-0 z-30 w-64 h-[calc(100vh-4rem)] bg-white border-r border-secondary-200 transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full'
                    } lg:translate-x-0`}
            >
